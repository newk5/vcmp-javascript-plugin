...
public class PlayerUpdateEvents {
    ...
    public void update(Player player) {
        ...
        if (pd.getLastHP() != player.getHP()) {
            eventHandler.onPlayerHealthChange(player, pd.getLastHP(), player.getHP());
            pd.setLastHP(player.getHP());
        }
        ...
        if (pd.getLastX() != player.getPosition().getX() || pd.getLastY() != player.getPosition().getY() || pd.getLastY() != player.getPosition().getY()) {
            eventHandler.onPlayerMove(player, pd.getLastX(), pd.getLastY(), pd.getLastZ(), player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
            pd.setLastX(player.getPosition().getX());
            pd.setLastY(player.getPosition().getY());
            pd.setLastZ(player.getPosition().getZ());
        }
